...
%% Change these:
\newcommand{\projecttitle}{Walking Tours System for the Galway Civic Trust using MEAN stack and Ionic Framework}
\newcommand{\projectauthor}{Arjun Kharel \\[0.2cm] Trevor Davies \\[0.2cm] Patryk Piecha}
