...
\paragraph{Abstract}
This project has been done for the Galway Civic Trust. The purpose of the project was to create a means by which the trust could create walking tours with out the need to have a separate mobile app for each tour.
The system comprises of two parts a cross platform mobile application and a web application. The web application has been done using a MEAN stack approach ... more to come
...
The process of deciding which technologies to use was done after the initial meeting with the Galway Civic Trust. After receiving the requirements we started to research which technologies and processes would be best suited for the project based on the requirements. It was decided very early that a NoSQL Database would be best for the backend and a cross platform development framework for the mobile app. We then discussed which NoSQL database to use and decided that MongoDB would be used, and the for the mobile app, we decided to use the Ionic Mobile Framework. Because of using MongoDB a MEAN stack approach was taking for developing the back end server side At this point we created a project plan using Microsoft Project .. more to come
